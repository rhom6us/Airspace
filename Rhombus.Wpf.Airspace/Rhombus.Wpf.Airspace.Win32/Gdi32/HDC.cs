...
namespace Rhombus.Wpf.Airspace.Win32.Gdi32 {
    ...
    public class HDC : HGDIOBJ {
        ...
        /// </remarks>
        public HDC(IntPtr hdc) : base(hdc) { }

        public static HDC CreateCompatibleDC(HDC hdc) {
            HDC value = null;

            if (hdc == null)
                value = HDC._CreateCompatibleDC(IntPtr.Zero);
            else
                value = HDC._CreateCompatibleDC(hdc);
        ...
        public HGDIOBJ SelectObject(HGDIOBJ obj) {
            var oldObject = HDC.SelectObject(this, obj);
        ...
        public HBRUSH SelectBrush(HBRUSH brush) {
            return (HBRUSH) this.SelectObject(brush);
        }

        public bool FillRect(ref User32.RECT rect, HBRUSH brush) {
            return HDC.FillRect(this, ref rect, brush);
        }

        public bool FillRect(ref User32.RECT rect, COLOR color) {
            return HDC.FillRect(this, ref rect, (int) color + 1);
        }
        ...
        [System.Runtime.InteropServices.DllImport("gdi32.dll", EntryPoint = "CreateCompatibleDC")]
        ...
        [return: System.Runtime.InteropServices.MarshalAs(System.Runtime.InteropServices.UnmanagedType.Bool)]
        private static extern bool FillRect(HDC hDC, ref User32.RECT lprc, HBRUSH hbr);

        [System.Runtime.InteropServices.DllImport("user32.dll", CharSet = System.Runtime.InteropServices.CharSet.Auto)]
        [return: System.Runtime.InteropServices.MarshalAs(System.Runtime.InteropServices.UnmanagedType.Bool)]
        private static extern bool FillRect(HDC hDC, ref User32.RECT lprc, int color);
