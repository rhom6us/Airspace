...
namespace Rhombus.Wpf.Airspace.Media.Imaging {
    public class CustomBitmap : System.Windows.Media.Imaging.BitmapSource, IDisposable {
        #region Freezable
        ...
        protected override System.Windows.Freezable CreateInstanceCore() {
            return (System.Windows.Freezable) Activator.CreateInstance(this.GetType());
        }
        ...
        ///     CopyCommon method.
        /// </remarks>
        protected sealed override void CloneCore(System.Windows.Freezable source) {
            base.CloneCore(source);

            var customBitmapSource = (CustomBitmap) source;
            this.CopyCore(customBitmapSource, /*useCurrentValue*/ false, /*willBeFrozen*/ false);
        }
        ...
        ///     CopyCommon method.
        /// </remarks>
        protected sealed override void CloneCurrentValueCore(System.Windows.Freezable source) {
            base.CloneCurrentValueCore(source);

            var customBitmapSource = (CustomBitmap) source;
            this.CopyCore(customBitmapSource, /*useCurrentValue*/ true, /*willBeFrozen*/ false);
        }
        ...
        ///     CopyCommon method.
        /// </remarks>
        protected sealed override void GetAsFrozenCore(System.Windows.Freezable source) {
            base.GetAsFrozenCore(source);

            var customBitmapSource = (CustomBitmap) source;
            this.CopyCore(customBitmapSource, /*useCurrentValue*/ false, /*willBeFrozen*/ true);
        }
        ...
        ///     CopyCommon method.
        /// </remarks>
        protected sealed override void GetCurrentValueAsFrozenCore(System.Windows.Freezable source) {
            base.GetCurrentValueAsFrozenCore(source);

            var customBitmapSource = (CustomBitmap) source;
            this.CopyCore(customBitmapSource, /*useCurrentValue*/ true, /*willBeFrozen*/ true);
        }
        ...
        ///     Derived classes can override this to specify their own value.
        /// </remarks>
        public override System.Windows.Media.PixelFormat Format => System.Windows.Media.PixelFormats.Bgr32;
        ...
        public sealed override void CopyPixels(Array pixels, int stride, int offset) {
            var sourceRect = new System.Windows.Int32Rect(0, 0, this.PixelWidth, this.PixelHeight);
            this.CopyPixels(sourceRect, pixels, stride, offset);
        }
        ...
        ///     custom logic.
        /// </remarks>
        public sealed override void CopyPixels(System.Windows.Int32Rect sourceRect, Array pixels, int stride, int offset) {
            int elementSize;
            int bufferSize;
            Type elementType;
            this.ValidateArrayAndGetInfo(pixels, out elementSize, out bufferSize, out elementType);
            ...
            checked {
                ...
                var arrayHandle = System.Runtime.InteropServices.GCHandle.Alloc(pixels, System.Runtime.InteropServices.GCHandleType.Pinned);
                try {
                    ...
                    this.CopyPixels(sourceRect, buffer, bufferSize, stride);
                }
                finally {
                    arrayHandle.Free();
                }
        ...
        ///     custom logic.
        /// </remarks>
        public sealed override void CopyPixels(System.Windows.Int32Rect sourceRect, IntPtr buffer, int bufferSize, int stride) {
            ...
            if (sourceRect.X + sourceRect.Width > this.PixelWidth)
                throw new ArgumentOutOfRangeException("sourceRect");
            ...
            if (sourceRect.Y + sourceRect.Height > this.PixelHeight)
                throw new ArgumentOutOfRangeException("sourceRect");
            ...
            checked {
                ...
                var minStrideInBits = (uint) (sourceRect.Width * this.Format.BitsPerPixel);
            ...
            this.CopyPixelsCore(sourceRect, stride, bufferSize, buffer);
        }
        ...
        ///     of "stride" bytes).
        /// </remarks>
        protected virtual void CopyPixelsCore(System.Windows.Int32Rect sourceRect, int stride, int bufferSize, IntPtr buffer) { }
        ...
        /// </param>
        private void ValidateArrayAndGetInfo(Array pixels, out int elementSize, out int sourceBufferSize, out Type elementType) {
            //
            ...
            if (pixels.Rank == 1) {
                ...
                checked {
                    ...
                    elementSize = System.Runtime.InteropServices.Marshal.SizeOf(exemplar);
        ...
        protected void RaiseDownloadCompleted() {
            var downloadCompleted = _downloadCompleted;
        ...
        ///     the base implementation does nothing.
        /// </remarks>
        public override event EventHandler<System.Windows.Media.Imaging.DownloadProgressEventArgs> DownloadProgress {
        ...
        /// </summary>
        /// <param name="e"></param>
        protected void RaiseDownloadProgress(System.Windows.Media.Imaging.DownloadProgressEventArgs e) {
            var downloadProgress = _downloadProgress;
            if (downloadProgress != null)
                downloadProgress(this, e);
        }

        private EventHandler<System.Windows.Media.Imaging.DownloadProgressEventArgs> _downloadProgress;
        ...
        /// </summary>
        /// <param name="e"></param>
        protected void RaiseDownloadFailed(System.Windows.Media.ExceptionEventArgs e) {
            var downloadFailed = _downloadFailed;
            if (downloadFailed != null)
                downloadFailed(this, e);
        }

        private EventHandler<System.Windows.Media.ExceptionEventArgs> _downloadFailed;
        ...
        /// </summary>
        /// <param name="e"></param>
        protected void RaiseDecodeFailed(System.Windows.Media.ExceptionEventArgs e) {
            var decodeFailed = _decodeFailed;
            if (decodeFailed != null)
                decodeFailed(this, e);
        }

        private EventHandler<System.Windows.Media.ExceptionEventArgs> _decodeFailed;
        ...
        protected virtual void Dispose(bool disposing) {
            if (disposing) {
                ...
                var _wicSource = this.GetType().GetField("_wicSource", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
                var handle = _wicSource.GetValue(this) as System.Runtime.InteropServices.SafeHandle;
